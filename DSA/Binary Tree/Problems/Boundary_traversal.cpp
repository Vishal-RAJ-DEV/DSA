...
public:
    ...
    void addLeaves(Node* root, vector<int>& res) {
        ...
        if (root->left) {
            addLeaves(root->left, res);  //here we are going to left first because we want to print the left leaf first
        }
        if (root->right) {
            addLeaves(root->right, res);  //here we are going to right after left because we want to print the right leaf after left leaf
        }
    }
