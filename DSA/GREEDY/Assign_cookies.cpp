...
/// here we greedyly assign the cookie to the student if the cookie is greater than or equal to the greed of the student
//this algorithm works because we are sorting both the arrays and we are trying to satisfy the student with the least greed first and then move to the next student and so on
class Solution {
public:
